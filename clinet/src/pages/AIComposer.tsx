    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      <div className="space-y-6 pt-12 border-t border-slate-100">
        <div className="flex items-center justify-between text-slate-600">
          ...
          <span className="text-md text-slate-500 bg-slate-50 px-2">
              ...
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    <div className='relative'>
                      ...
                      <input type="date" className='w-full pl-11 pr-4 py-3 bg-slate-50 border border-r-slate-100 rounded-md text-slate-900 text-sm focus:outline-none transition-all' value={scheduledDate} onChange={(e) => setScheduledDate(e.target.value)}/>
                    </div>

                    <div className='relative'>
                      <ClockIcon className='size-4 absolute left-4 top-1/2 -translate-y-1/2 text-slate-400'/>
                      <input type="time" className='w-full pl-11 pr-4 py-3 bg-slate-50 border border-r-slate-100 rounded-md text-slate-900 text-sm focus:outline-none transition-all' value={scheduledTime} onChange={(e) => setScheduledTime(e.target.value)}/>
                    </div>
                </div>
              </div>
